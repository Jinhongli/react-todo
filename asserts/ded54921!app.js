...
var TodoApp = function (_React$Component) {
    ...
    _createClass(TodoApp, [{
        ...
        key: 'editTodo',
        value: function editTodo(id, value) {
            this.setState({
                todos: this.state.todos.map(function (todo) {
                    if (id === todo.id) {
                        todo.content = value;
...
var _TodoItem = __webpack_require__(38);
...
var TodoList = function (_React$Component) {
    ...
    _createClass(TodoList, [{
        ...
        key: 'handleEdit',
        value: function handleEdit(id, value) {
        ...
        value: function render() {
            ...
            var todoItems = this.props.todos.map(function (todo) {
                return _react2.default.createElement(_TodoItem2.default, {
                    ...
                    handleCheck: _this2.handleCheck.bind(_this2),
                    handleEdit: _this2.handleEdit.bind(_this2, todo.id) });
            });
...
var _TodoItemEdit = __webpack_require__(39);

var _TodoItemEdit2 = _interopRequireDefault(_TodoItemEdit);
    ...
    _createClass(TodoItem, [{
        ...
        value: function render() {
            return !this.state.edit ? _react2.default.createElement(
                'li',
                { className: this.props.todo.checked ? 'todo-item check' : 'todo-item' },
                _react2.default.createElement('input', { className: 'todo-item-check', type: 'checkbox', onClick: this.props.handleCheck.bind(this, this.props.todo.id) }),
                this.props.todo.content,
                _react2.default.createElement(
                    'a',
                    { className: 'is-pulled-right', onClick: this.props.handleDelete.bind(this, this.props.todo.id) },
                    _react2.default.createElement(
                        'span',
                ...
                _react2.default.createElement(
                    'a',
                    { className: 'is-pulled-right', onClick: this.handleEdit.bind(this) },
                    _react2.default.createElement(
                        'span',
...
var TodoItemEdit = function (_React$Component) {
    _inherits(TodoItemEdit, _React$Component);

    function TodoItemEdit(props) {
        _classCallCheck(this, TodoItemEdit);
...
var AddTodo = function (_React$Component) {
    ...
    _createClass(AddTodo, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'todo-input is-clearfix' },
                _react2.default.createElement('input', {
